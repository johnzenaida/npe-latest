...
= 7.1.3 =
1. Created show_all_taxonomies attribute
2. Created show_all_taxonomy_types attribute
3. Added custom taxonomy css classes in form of "custom-taxonomy-" + slug to wrapper css
4. Made plugin to work only with public blogs.
...
7. Made it to insert "tags" css classes in form of "tag-tag_slug".
8. Created show_all_taxonomies attribute
9. Created show_all_taxonomy_types attribute
10. Added custom taxonomy css classes in form of "custom-taxonomy-" + slug to wrapper css
11. Made plugin to work only with public blogs.
